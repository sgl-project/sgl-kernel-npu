...
function build_ops(){
    ...
    rm -rf vendors
    source ${current_script_dir}/build_ascendc_ops.sh -n 'laser_attention;block_sparse_attention;sparse_block_estimate;sparse_attention_score' -c 'ascend910;ascend910b;ascend910_93'
