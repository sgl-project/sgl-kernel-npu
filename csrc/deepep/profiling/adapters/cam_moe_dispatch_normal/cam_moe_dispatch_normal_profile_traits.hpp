#ifndef DEEPEP_PROFILING_ADAPTERS_CAM_MOE_DISPATCH_NORMAL_PROFILE_TRAITS_HPP
#define DEEPEP_PROFILING_ADAPTERS_CAM_MOE_DISPATCH_NORMAL_PROFILE_TRAITS_HPP

#include <cstdint>
#include <string>

#include "profiling/adapters/cam_moe_dispatch_normal/cam_moe_dispatch_normal_profile_payload.h"
#include "profiling/adapters/cam_moe_dispatch_normal/cam_moe_dispatch_normal_profile_stage.h"
...
static_assert(kStageCount <= Cam::PROFILE_ACTIVE_STAGE_CAPACITY,
              "cam_moe_dispatch_normal stage count must fit in active profiling stage capacity");
...
#endif  // DEEPEP_PROFILING_ADAPTERS_CAM_MOE_DISPATCH_NORMAL_PROFILE_TRAITS_HPP
