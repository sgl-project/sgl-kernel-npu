...
struct GemmIdentityBlockSwizzle {
  ...
  ACT_DEVICE
  GemmIdentityBlockSwizzle(GemmCoord const &problemShape_,
...
struct SplitkGemmIdentityBlockSwizzle {
  ...
  ACT_DEVICE
  SplitkGemmIdentityBlockSwizzle(GemmCoord const &problemShape_,
                                 GemmCoord const &tileShape_,
  ...
  uint32_t GetKIdxBySplitkSliceIdx(uint32_t splitkSliceIdx) const {
    if (splitkSliceIdx < loopsMNK.k() % splitkFactor) {
      ...
      return splitkSliceIdx * (loopsMNK.k() / splitkFactor) +
             loopsMNK.k() % splitkFactor;
    }
  }
