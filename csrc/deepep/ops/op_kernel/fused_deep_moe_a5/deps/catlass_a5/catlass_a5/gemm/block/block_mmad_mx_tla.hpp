...
struct BlockMmadTla<MmadMx<ArchTag_, ENABLE_UNIT_FLAG_, L1_SCALE_FACTOR_K_, L0C_STAGES_, ENABLE_L1_RESIDENT_,
...
public:
    // Type Aliases
    using DispatchPolicy = MmadMx<ArchTag_, ENABLE_UNIT_FLAG_, L1_SCALE_FACTOR_K_, L0C_STAGES_, ENABLE_L1_RESIDENT_,
                                  L1A_STAGES_, L1B_STAGES_, L0A_STAGES_, L0B_STAGES_>;
                                   ...
                                   TensorBias const &tensorBias = {})
    {
        ...
        if constexpr (ENABLE_L1_RESIDENT) {
            ...
            if (lastAddrA[l1AListId] != tensorTileA.data().GetPhyAddr() ||
                ...
                lastCoordA[l1AListId] = MatrixCoord{static_cast<MatrixCoord::Index>(tla::get<0>(tensorTileA.coord())),
        ...
        if constexpr (ENABLE_L1_RESIDENT) {
            if (lastAddrB[l1BListId] != tensorTileB.data().GetPhyAddr() ||
                ...
                lastCoordB[l1BListId] = MatrixCoord{static_cast<MatrixCoord::Index>(tla::get<0>(tensorTileB.coord())),
                ...
                if constexpr (ENABLE_L1_RESIDENT) {
                    if (lastAddrA[l1AListIdNext] != tensorTileA.data().GetPhyAddr() ||
                        ...
                        lastCoordA[l1AListIdNext] =
                            MatrixCoord{static_cast<MatrixCoord::Index>(tla::get<0>(tensorTileA.coord())),
                                        static_cast<MatrixCoord::Index>(tla::get<1>(tensorTileA.coord()))};
                ...
                if constexpr (ENABLE_L1_RESIDENT) {
                    if (lastAddrB[l1BListIdNext] != tensorTileB.data().GetPhyAddr() ||
                        ...
                        lastCoordB[l1BListIdNext] =
                            MatrixCoord{static_cast<MatrixCoord::Index>(tla::get<0>(tensorTileB.coord())),
                                        static_cast<MatrixCoord::Index>(tla::get<1>(tensorTileB.coord()))};
