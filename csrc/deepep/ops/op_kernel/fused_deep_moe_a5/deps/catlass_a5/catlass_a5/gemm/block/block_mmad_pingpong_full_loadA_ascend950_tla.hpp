...
template <class ArchTag_, bool ENABLE_UNIT_FLAG_, bool USE_HF32_MODE_, uint32_t L0C_STAGES_, bool ENABLE_L1_RESIDENT_,
          ...
          class TileMmad_>
struct BlockMmadTla<MmadAscend950FullLoadA<ArchTag_, ENABLE_UNIT_FLAG_, USE_HF32_MODE_, L0C_STAGES_,
...
public:
    ...
    using DispatchPolicy =
        MmadAscend950FullLoadA<ArchTag_, ENABLE_UNIT_FLAG_, USE_HF32_MODE_, L0C_STAGES_, ENABLE_L1_RESIDENT_,
            ...
            for (int mL0Idx = 0; mL0Idx < mL0Loop; mL0Idx++) {
                ...
                for (int kL0Idx = 0; kL0Idx < kL0Loop; kL0Idx++) {
                    ...
                    auto tensorTileL1A = GetTileA(tensorL1A, mL0Idx * L0_TILE_M,
                                                  kL0Idx * L0_TILE_K + kL1Idx * L1_TILE_K, mL0Actual, kL0Actual);
