...
template <class ArchTag_, bool ENABLE_UNIT_FLAG_, bool ENABLE_SHUFFLE_K_, bool USE_HF32_MODE_, uint32_t L0C_STAGES_,
...
struct BlockMmadTla<MmadFullLoadA<ArchTag_, ENABLE_UNIT_FLAG_, ENABLE_SHUFFLE_K_, USE_HF32_MODE_, L0C_STAGES_,
...
public:
    // Type Aliases
    using DispatchPolicy = MmadFullLoadA<ArchTag_, ENABLE_UNIT_FLAG_, ENABLE_SHUFFLE_K_, USE_HF32_MODE_, L0C_STAGES_,
                                         ENABLE_L1_RESIDENT_, L1A_STAGES_, L1B_STAGES_, L0A_STAGES_, L0B_STAGES_>;
        ...
        for (uint32_t kL1Idx = 0; kL1Idx < kTileCount; kL1Idx++) {
            ...
            for (int mL0Idx = 0; mL0Idx < mL0Loop; mL0Idx++) {
                ...
                for (int kL0Idx = 0; kL0Idx < kL0Loop; kL0Idx++) {
                    ...
                    auto tensorTileL1A = GetTileA(tensorL1A, mL0Idx * L0_TILE_M,
                                                  kL0Idx * L0_TILE_K + shuffleKIdx * L1_TILE_K, mL0Actual, kL0Actual);
