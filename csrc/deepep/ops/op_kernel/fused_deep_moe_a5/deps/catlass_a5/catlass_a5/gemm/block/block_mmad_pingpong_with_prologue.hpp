...
#include "catlass_a5/gemm/tile/tile_traits.hpp"
...
struct BlockMmad<MmadAtlasA2PingPongWithPrologue<ENABLE_UNIT_FLAG_>, L1TileShape_, L0TileShape_, AType_, BType_, CType_,
...
protected:
    CATLASS_DEVICE
    void PrologueImpl(typename Tile::PrologueTraits<PrologueA>::TensorSrc const &gmSrcA,
