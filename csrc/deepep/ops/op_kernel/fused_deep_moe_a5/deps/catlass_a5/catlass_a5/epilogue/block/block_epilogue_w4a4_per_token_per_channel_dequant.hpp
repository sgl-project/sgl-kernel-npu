...
template <class CType_, class PerTokenScaleType_, class DType_, class TileBroadcastOneBlk_,
          class TileOneBlkColumnBroadcastMul_, class TileCopy_, class EpilogueTileSwizzle_>
class BlockEpilogue<EpilogueAtlasA2W4A4PerTokenPerChannelDequant, CType_, PerTokenScaleType_, DType_,
...
public:
    ...
    BlockEpilogue(Arch::Resource<ArchTag> const &resource, Params const &params = Params{}) : params(params)
    {
        ...
        // Calculation (with perToken scale)
