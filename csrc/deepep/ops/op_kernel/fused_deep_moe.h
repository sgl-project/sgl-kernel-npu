...
void GmmDeqSwigluQuant(
    ...
    GM_ADDR gmWorkspace,
    GM_ADDR gmX, GM_ADDR debugGm, GM_ADDR gmexpertIds,
...
)
{
    ...
    if constexpr (EXEC_FLAG & EXEC_FLAG_DEEP_FUSE) {
        typename GemmKernel::Params params{
            ...
            gmExpandIdx, gmEpSendCount, gmResvered,
            epRankSize,
            epRankId,
            moeExpertNum,
            moeExpertNumPerRank,
...
)
{
    ...
    using BlockEpilogue = Catlass::Epilogue::Block::BlockEpilogue<EpilogueDispatchPolicy, CType, ScaleType, PerTokenScaleType,
        DType, TileRowBroadcastMul, TileBroadcastOneBlk, TileOneBlkColumnBroadcastMul, TileCopy, TileScheduler>;
...
public:
    ...
    __aicore__ inline void Init(
        // input
        GM_ADDR x, GM_ADDR expert_ids,
        GM_ADDR gmm1_permuted_weight, GM_ADDR gmm1_permuted_weight_scale, GM_ADDR gmm2_weight,
        GM_ADDR gmm2_weight_scale, GM_ADDR expert_smooth_scales, GM_ADDR expert_scales,
        // output
        GM_ADDR output,
        // system
...
__aicore__ inline void FusedDeepMoe<TemplateMC2TypeFunc>::Process()
{
    ...
    GmmDeq<TemplateMC2TypeFunc, Gmm2L1TileShape, Gmm2L0TileShape, Gmm2EpilogueTileShape,
        ...
        layoutScale2, gmPerTokenScale2, layoutPerTokenScale2, gmGmm2DepOut, layoutOutput, gmWorkspace, &combiner);
#endif
}
