...
extern "C" __global__ __aicore__ void dispatch_ffn_combine_m3(GM_ADDR x, GM_ADDR w1, GM_ADDR w2, GM_ADDR expert_idx,
                                                              GM_ADDR scale1, GM_ADDR scale2, GM_ADDR probs,
                                                              GM_ADDR out, GM_ADDR expert_token_nums, GM_ADDR workspace,
                                                              GM_ADDR tiling)
{
