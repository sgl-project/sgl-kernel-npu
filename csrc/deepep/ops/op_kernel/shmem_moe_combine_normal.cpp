...
extern "C" __global__ __aicore__ void shmem_moe_combine_normal(GM_ADDR recvX, GM_ADDR epRecvCount,
...

{
    ...
    op.Init(recvX, epRecvCount, topkWeights, topkIdx, sendTokenIdx, XOut, sendCostStatsOut,
