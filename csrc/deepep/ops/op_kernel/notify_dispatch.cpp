...
extern "C" __global__ __aicore__ void notify_dispatch(GM_ADDR sendData, GM_ADDR tokenPerExpertData,
                                                      GM_ADDR profileBufferGM, GM_ADDR sendDataOffset,
                                                      GM_ADDR recvData, GM_ADDR recvCount, GM_ADDR recvOffset,
                                                      GM_ADDR expertGlobalOffset, GM_ADDR srcrankInExpertOffset,
                                                      GM_ADDR rInSrcrankOffset, GM_ADDR totalRecvTokens, GM_ADDR maxBs,
