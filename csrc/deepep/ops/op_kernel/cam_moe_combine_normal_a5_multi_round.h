#ifndef CAM_MOE_COMBINE_NORMAL_A5_MULTI_ROUND_H
#define CAM_MOE_COMBINE_NORMAL_A5_MULTI_ROUND_H
...
namespace CamMoeCombineNormalA5MultiRoundImpl {
...
// Each round-state entry occupies one 32-byte cache line. At the largest
// supported A5 shape (8192 tokens, topk 16), one ping-pong slot needs 4 MiB.
// Keep two slots so one round can be consumed while the next is produced.
constexpr uint64_t STATE_WIN_SIZE = 8UL * 1024UL * 1024UL;
constexpr uint64_t STATE_WIN_SIZE_HALF = STATE_WIN_SIZE / 2;
constexpr uint64_t MAX_STATE_TOKENS = 8192UL;
constexpr uint64_t MAX_STATE_TOPK = 16UL;
...
static_assert(STATE_WIN_SIZE_HALF >= MAX_STATE_TOKENS * MAX_STATE_TOPK * UB_32_ALIGN,
              "A5 multi-round Combine state slot is too small for the supported shape");
...
class CamMoeCombineNormalA5MultiRound
{
public:
    __aicore__ inline CamMoeCombineNormalA5MultiRound(){};
...
template <TemplateMC2TypeClass>
__aicore__ inline void CamMoeCombineNormalA5MultiRound<TemplateMC2TypeFunc>::InitMagic()
{
...
template <TemplateMC2TypeClass>
__aicore__ inline void CamMoeCombineNormalA5MultiRound<TemplateMC2TypeFunc>::InitGlobalBuffer(
...
CamMoeCombineNormalA5MultiRound<TemplateMC2TypeFunc>::InitTilingData(const CamMoeCombineNormalTilingData *tilingData)
{
...
template <TemplateMC2TypeClass>
__aicore__ inline void CamMoeCombineNormalA5MultiRound<TemplateMC2TypeFunc>::InitBuffLen()
{
...
template <TemplateMC2TypeClass>
__aicore__ inline void CamMoeCombineNormalA5MultiRound<TemplateMC2TypeFunc>::InitRoundSendData()
{
...
template <TemplateMC2TypeClass>
__aicore__ inline void CamMoeCombineNormalA5MultiRound<TemplateMC2TypeFunc>::InitRoundRecvData()
{
...
template <TemplateMC2TypeClass>
__aicore__ inline void CamMoeCombineNormalA5MultiRound<TemplateMC2TypeFunc>::Init(
...
template <TemplateMC2TypeClass>
__aicore__ inline void CamMoeCombineNormalA5MultiRound<TemplateMC2TypeFunc>::CopyBufferToShareAndSetStatus()
{
...
template <TemplateMC2TypeClass>
__aicore__ inline void CamMoeCombineNormalA5MultiRound<TemplateMC2TypeFunc>::CopyBufferToShare(uint32_t srcRankId,
                                                                                               uint32_t srcTokenId,
                                                                                               uint32_t srcTopkId,
                                                                                               uint32_t tkIndex)
{
...
template <TemplateMC2TypeClass>
__aicore__ inline void CamMoeCombineNormalA5MultiRound<TemplateMC2TypeFunc>::SetStatusBySrcInfo(uint32_t srcRankId,
                                                                                                uint32_t srcTokenId,
                                                                                                uint32_t srcTopkId)
{
...
template <TemplateMC2TypeClass>
__aicore__ inline void CamMoeCombineNormalA5MultiRound<TemplateMC2TypeFunc>::WaitBuffCopy(uint32_t recvXTokenIdx,
...
template <TemplateMC2TypeClass>
__aicore__ inline void CamMoeCombineNormalA5MultiRound<TemplateMC2TypeFunc>::ReadBufferAndWeightedSum(
...
template <TemplateMC2TypeClass>
__aicore__ inline void CamMoeCombineNormalA5MultiRound<TemplateMC2TypeFunc>::ReadBufferFromRemote()
{
...
template <TemplateMC2TypeClass>
__aicore__ inline void CamMoeCombineNormalA5MultiRound<TemplateMC2TypeFunc>::SetRoundStatus()
{
    if (coreIdx_ != 0) {
        return;
    }
...
template <TemplateMC2TypeClass>
__aicore__ inline void CamMoeCombineNormalA5MultiRound<TemplateMC2TypeFunc>::WaitRoundStatus()
{
    if (coreIdx_ != 0) {
        return;
    }
...
template <TemplateMC2TypeClass>
__aicore__ inline void CamMoeCombineNormalA5MultiRound<TemplateMC2TypeFunc>::Process()
{
...
#endif  // CAM_MOE_COMBINE_NORMAL_A5_MULTI_ROUND_H
