...
aclnnStatus aclnnDispatchFFNCombineM3GetWorkspaceSize(const aclTensor *x, const aclTensor *weight1,
...
{
    return aclnnInnerDispatchFFNCombineM3GetWorkspaceSize(x, weight1, weight2, expertId, scale1, scale2, probs, group,
                                                          epRankSize, epRankId, maxOutputSize, false, true, out,
