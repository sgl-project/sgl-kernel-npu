...
__attribute__((visibility("default"))) aclnnStatus aclnnCamMoeCombineNormalGetWorkspaceSize(
    ...
    const aclTensor *recvTopkWeights, const aclTensor *tokenIdx, const aclTensor *tokenIdxMap, const aclTensor *tpRecvCountsOptional, char *epGroupName, int64_t epWorldSize,
