...
__attribute__((visibility("default"))) aclnnStatus aclnnCamMoeDispatchNormalGetWorkspaceSize(
    ...
    const aclTensor *srcrank_in_expert_offset, const aclTensor *r_in_srcrank_offset, char *groupEp,
    int64_t epWorldSize, int64_t epRankId, char *groupTpOptional, int64_t tpWorldSize, int64_t tpRankId,
