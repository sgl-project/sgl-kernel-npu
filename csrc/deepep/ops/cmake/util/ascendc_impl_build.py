...
{}
    ...
    options.append("-I" + SHMEM_HOME_PATH + "/shmem/include/device/gm2gm")
    options.append("-I" + SHMEM_HOME_PATH + "/shmem/include/device/ub2gm")
    options.append("-I" + SHMEM_HOME_PATH + "/shmem/include/device/team")
    # options.append("-I" + SHMEM_HOME_PATH + "/shmem/include/device/ub2gm/engine")
    # options.append("-I" + SHMEM_HOME_PATH + "/shmem/include/device/gm2gm/engine")
    ...
    options.append("-I" + SHMEM_HOME_PATH + "/shmem/src/host_device")
