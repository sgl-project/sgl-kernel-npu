    ...
    double keep_prob, int64_t pre_tokens, int64_t next_tokens, bool is_highPrecision)
{
    ...
    tilingData->coreGroupNum = groupNum;

    EXEC_KERNEL_CMD(ascend_laser_attention, aicNum, query, key, value, ptr, ptr, ptr, softmax_log_max_sum, attention_out, workspace_tensor, tilingBuffer);
