...
constexpr uint32_t L0AB_SHARED_SIZE_64K = 65536;
constexpr uint32_t L0C_SHARED_SIZE_256K = 262144;

constexpr uint32_t BUFFER_SIZE_16K = 16384;
constexpr uint32_t BUFFER_SIZE_32K = 32768;
constexpr uint32_t BUFFER_SIZE_128K = 131072;
