...
TEMPLATE_INTF
__aicore__ inline void CalculateQueryOffset(RunParamStr &runParam, const ConstInfo &constInfo, int32_t bIdx,
                                          ...
                                          __gm__ int32_t *actualSeqQlenAddr, __gm__ int32_t *actualSeqKvlenAddr)
{
    ...
    if constexpr (LAYOUT_T == SFA_LAYOUT::TND) {
        ...
        actualS1Size = (actualSeqQlenAddr == nullptr) ? constInfo.s1Size : actualSeqQlenAddr[sIdx];
    }
