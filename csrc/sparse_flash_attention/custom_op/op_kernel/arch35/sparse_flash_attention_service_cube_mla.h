...
private:
    ...
    // --------------------Bmm2--------------------------
    __aicore__ inline void
    IterateBmm2SFA(Buffer<BufferType::UB, SyncType::CROSS_CORE_SYNC_BOTH> &outputBuf,
                   BuffersPolicy3buff<BufferType::L1, SyncType::CROSS_CORE_SYNC_FORWARD> &inputLeftBuffers,
                   Buffer<BufferType::L1, SyncType::CROSS_CORE_SYNC_FORWARD> &inputRightBuf, RunInfo &runInfo,
                   ConstInfo &constInfo);
    TPipe *tPipe;
...
TEMPLATES_DEF_NO_DEFAULT
__aicore__ inline void SFAMatmulService<TEMPLATE_ARGS>::InitLocalBuffer(BufferManager<BufferType::L1> &l1BuffMgr)
{
...
TEMPLATES_DEF_NO_DEFAULT
__aicore__ inline void SFAMatmulService<TEMPLATE_ARGS>::InitGmTensor(__gm__ uint8_t *actualSeqLengthsQ,
                                                                     const ConstInfo &constInfo)
{
