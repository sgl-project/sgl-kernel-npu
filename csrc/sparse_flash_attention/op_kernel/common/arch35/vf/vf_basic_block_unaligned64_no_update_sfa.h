...
__simd_vf__ void ProcessVec1NoUpdateImpl64VF(__ubuf__ T2 *expUb, __ubuf__ T *expSumUb, __ubuf__ T *maxUb,
                                             __ubuf__ T *maxUbStart, __ubuf__ T *srcUb, const uint32_t blockStride,
                                             ...
                                             const T minValue, uint32_t pltOriginalN, uint32_t pltSrcN)
{
    ...
    for (uint16_t i = 0; i < m; ++i) {
        ...
        AscendC::MicroAPI::StoreUnAlign<float, MicroAPI::PostLiteral::POST_MODE_UPDATE>(((__ubuf__ T *&)expSumUb),
        ...
        if constexpr (IsSameType<T2, bfloat16_t>::value) {
            ...
            AscendC::MicroAPI::DeInterleave(vreg_dst_even_bf16, vreg_dst_odd_bf16, vreg_exp_bf16, vreg_exp_bf16);
            ...
            AscendC::MicroAPI::DeInterleave(vreg_dst_even_fp16, vreg_dst_odd_fp16, vreg_exp_fp16, vreg_exp_fp16);
            AscendC::MicroAPI::StoreAlign<T2, MicroAPI::DataCopyMode::DATA_BLOCK_COPY,
                                          MicroAPI::PostLiteral::POST_MODE_UPDATE>(
