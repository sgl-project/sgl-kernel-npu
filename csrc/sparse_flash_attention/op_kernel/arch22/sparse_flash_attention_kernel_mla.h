...
public:
    ...
    __aicore__ inline void Init(__gm__ uint8_t *query, __gm__ uint8_t *key, __gm__ uint8_t *value,
                                ...
                                const __gm__ SparseFlashAttentionTilingDataMla *__restrict tiling,
...
private:
    ...
    const __gm__ SparseFlashAttentionTilingDataMla *__restrict tilingData = nullptr;
...
__aicore__ inline void SparseFlashAttentionMla<SFAT>::Init(
    ...
    __gm__ uint8_t *softmaxSum, __gm__ uint8_t *workspace,
    const __gm__ SparseFlashAttentionTilingDataMla *__restrict tiling, __gm__ uint8_t *gmTiling, TPipe *tPipe)
{
    if ASCEND_IS_AIV {
