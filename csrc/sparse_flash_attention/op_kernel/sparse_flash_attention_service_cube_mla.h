...
private:
    ...
    // mte2 <> mte1 EventID
    // L1 3buf, 使用3个eventId
    static constexpr uint32_t L1_EVENT0 = 2;
    static constexpr uint32_t L1_EVENT1 = 3;
    static constexpr uint32_t L1_EVENT2 = 4;
    static constexpr uint32_t L1_EVENT3 = 5;
    static constexpr uint32_t L1_EVENT4 = 6;
    static constexpr uint32_t L1_EVENT5 = 7;
    static constexpr uint32_t L1_EVENT6 = 1;

    // m <> mte1 EventID
    static constexpr uint32_t L0AB_EVENT0 = 3;
    static constexpr uint32_t L0AB_EVENT1 = 4;
