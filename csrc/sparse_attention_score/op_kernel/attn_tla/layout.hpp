...
HOST_DEVICE constexpr auto MakeLayout(T const &rows, U const &cols)
{
    ...
    if constexpr (std::is_same_v<LayoutTag, NpuArch::layout::VectorLayout>) {
        ...
        return MakeLayout(
            MakeShape(MakeShape(Int<NpuArch::C0_NUM_PER_FRACTAL>{}, NpuArch::CeilDiv(rows, Int<NpuArch::C0_NUM_PER_FRACTAL>{})),
            ...
            MakeStride(
                ...
                MakeStride(Int<1>{}, NpuArch::RoundUp((int64_t)rows, Int<NpuArch::C0_NUM_PER_FRACTAL>{}) * ELE_NUM_PER_C0)));
        ...
        return MakeLayout(
            ...
            MakeStride(
                MakeStride(Int<1>{}, NpuArch::RoundUp((int64_t)cols, Int<NpuArch::C0_NUM_PER_FRACTAL>{}) * ELE_NUM_PER_C0),
                MakeStride(Int<ELE_NUM_PER_C0>{}, Int<ELE_NUM_PER_FRACTAL>{})));
    }
}
...
HOST_DEVICE constexpr auto MakeMxScaleLayout(T const &rows, U const &cols)
{
    ...
    if constexpr (std::is_same_v<LayoutTag, NpuArch::layout::RowMajor>) {
        if constexpr (!isMxScaleB) {
            ...
            return MakeLayout(MakeShape(MakeShape(Int<ELE_NUM_PER_C0>{}, NpuArch::CeilDiv(rows, Int<ELE_NUM_PER_C0>{})), cols),
                              MakeStride(MakeStride(Int<1>{}, cols * ELE_NUM_PER_C0), Int<ELE_NUM_PER_C0>{}));
        }
    } else if constexpr (std::is_same_v<LayoutTag, NpuArch::layout::ColumnMajor>) {
        if constexpr (!isMxScaleB) {
            return MakeLayout(MakeShape(rows, MakeShape(Int<ELE_NUM_PER_C0>{}, NpuArch::CeilDiv(cols, Int<ELE_NUM_PER_C0>{}))),
        ...
        return MakeLayout(
            ...
            MakeStride(MakeStride(Int<1>{}, Int<ELE_NUM_PER_FRACTAL>{}),
                       MakeStride(Int<ELE_NUM_PER_C0>{},
                                  NpuArch::RoundUp((int64_t)rows, Int<ELE_NUM_PER_C0>{}) * NpuArch::C0_NUM_PER_FRACTAL)));
    }
}
