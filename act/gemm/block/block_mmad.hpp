...
template <class DispatchPolicy, class L1TileShape, class L0TileShape,
          ...
          class TileCopy = Gemm::Tile::TileCopy<
              typename DispatchPolicy::ArchTag, AType, BType, CType, BiasType>,
          class TileMmad = Gemm::Tile::TileMmad<
...
template <class DispatchPolicy, class L1TileShape, class L0TileShape,
          class TensorA, class TensorB, class TensorC, class TensorBias = void,
          class TileCopy = Gemm::Tile::PackedTileCopyTla<
              typename DispatchPolicy::ArchTag, TensorA, layout::RowMajor,
              TensorB, layout::RowMajor, TensorC, layout::RowMajor, TensorBias,
              layout::RowMajor>,
          class TileMmad = Gemm::Tile::TileMmadTla<
              typename DispatchPolicy::ArchTag, typename TileCopy::TensorL0A,
              typename TileCopy::TensorL0B, typename TileCopy::TensorL0C>>
struct BlockMmadTla {
  static_assert(DEPENDENT_FALSE<DispatchPolicy>,
                "BlockMmadTla is not implemented for this DispatchPolicy");
};
...
template <
    class DispatchPolicy, class L1TileShape, class L0TileShape, class AType,
    class BType, class CType, class BiasType = void,
    class TileCopy =
        Gemm::Tile::TileCopyGemm<typename DispatchPolicy::ArchTag, AType, BType,
                                 CType, BiasType>, // change the name
    class TileMmad = Gemm::Tile::TileMmad<typename DispatchPolicy::ArchTag,
                                          AType, BType, BiasType>>
struct BlockGemm {
  static_assert(DEPENDENT_FALSE<DispatchPolicy>,
                "BlockMmad is not implemented for this DispatchPolicy");
};
