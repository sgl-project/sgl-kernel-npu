...
template <class Element, class Layout> struct L1AlignHelper {
  static_assert(DEPENDENT_FALSE<Element>,
                "Unsupporteded align helper, can not find the specialization.");
};
...
template <class GmAType> struct L1ATypeSelector {
  static_assert(
      ...
      "Unsupporteded layout selector, can not find the specialization.");
};
...
struct L1AlignHelperTla {
  static_assert(
      ...
      "Unsupporteded align helper tla, can not find the specialization.");
};
...
///////////////////////////////////////
// new add
template <class GmAType> struct L1ATypeSelectorGemm {
  static_assert(
      DEPENDENT_FALSE<GmAType>,
      "Unsupporteded layout selector, can not find the specialization.");
};
...
template <class GmBType> struct L1BTypeSelectorGemm {
  static_assert(
      DEPENDENT_FALSE<GmBType>,
      "Unsupporteded layout selector, can not find the specialization.");
};
...
template <class L1Type> struct L0ATypeSelector {};
...
template <> struct L0ATypeSelector<Gemm::GemmType<int8_t, layout::nZ>> {
  using L0AType = Gemm::GemmType<int8_t, layout::zN>;
};

template <class L1Type> struct L0BTypeSelectorGemm {};
...
template <> struct L0BTypeSelectorGemm<Gemm::GemmType<int8_t, layout::zN>> {
...
template <class L1Type> struct L0BTypeSelectorGemv {};
...
template <> struct L0BTypeSelectorGemv<Gemm::GemmType<int8_t, layout::nZ>> {
