...
public:
  ...
  ACT_DEVICE AscendC::LocalTensor<Element>
...
template <class ArchTag, AscendC::TPosition Position> struct LocalTensorBuffer {
  static_assert(
      ...
      "Unsupporteded local tensor buffer, can not find the specialization.");
};

/// Partial specialization for TPosition::A1
template <class ArchTag>
struct LocalTensorBuffer<ArchTag, AscendC::TPosition::A1>
    : LocalTensorBufferBase {
public:
...
template <class ArchTag>
struct LocalTensorBuffer<ArchTag, AscendC::TPosition::A2>
    : LocalTensorBufferBase {
public:
...
template <class ArchTag>
struct LocalTensorBuffer<ArchTag, AscendC::TPosition::B1>
    : LocalTensorBufferBase {
public:
...
template <class ArchTag>
struct LocalTensorBuffer<ArchTag, AscendC::TPosition::B2>
    : LocalTensorBufferBase {
public:
...
template <>
struct LocalTensorBuffer<Arch::AtlasA2, AscendC::TPosition::C1>
    : LocalTensorBufferBase {
public:
...
template <>
struct LocalTensorBuffer<Arch::AtlasA2, AscendC::TPosition::C2>
    : LocalTensorBufferBase {
public:
  using ArchTag = Arch::AtlasA2;
...
template <class ArchTag>
struct LocalTensorBuffer<ArchTag, AscendC::TPosition::CO1>
    : LocalTensorBufferBase {
public:
...
template <>
struct LocalTensorBuffer<Arch::AtlasA2, AscendC::TPosition::C2PIPE2GM>
    : LocalTensorBufferBase {
public:
  using ArchTag = Arch::AtlasA2;
...
template <class ArchTag>
struct LocalTensorBuffer<ArchTag, AscendC::TPosition::VECIN>
    : LocalTensorBufferBase {
public:
...
template <class ArchTag>
struct LocalTensorBuffer<ArchTag, AscendC::TPosition::VECOUT>
    : LocalTensorBufferBase {
public:
...
template <class ArchTag>
struct LocalTensorBuffer<ArchTag, AscendC::TPosition::VECCALC>
    : LocalTensorBufferBase {
public:
