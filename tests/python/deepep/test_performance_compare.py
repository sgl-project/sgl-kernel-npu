...
from utils import init_dist, bench, calc_diff
...
def bench_func(func, name, rank, num_warmups=5, num_iters=20):
    # Warmup
    ...
    # ms
    t = start_event.elapsed_time(end_event) / num_iters
    return t
...
def test_compare(local_rank: int, num_local_ranks: int, args: argparse.Namespace):
    ...
    if rank == 0:
        ...
        print(f"Params: Tokens={args.num_tokens}, Hidden={args.hidden}, TopK={args.num_topk}, Experts={args.num_experts}")
