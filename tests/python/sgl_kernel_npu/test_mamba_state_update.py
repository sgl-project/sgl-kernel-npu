...
def test_conv_state_rollback_ref(
...
def test_conv_state_rollback(
    ...
    gt_states = test_conv_state_rollback_ref(
...
@torch.no_grad
def test_move_intermediate_cache_dynamic_h_block(
    L: int,
    S: int,
    D: int,
    H: int,
    ...
    move_intermediate_cache_dynamic_h_block(
        dst_cache_clone, src_cache, valid_tensor, last_steps_tensor
    )
