...
| MXFP8 逐 block | `"fp8_e4m3"` / `"fp8_e5m2"` | `float8_e4m3fn` / `float8_e5m2` | `float8_e8m0fnu` | 每 32 元素 | A5/C310 |
| 标量 FP8 | `"scalar_fp8_e4m3"` / `"scalar_fp8_e5m2"` | `float8_e4m3fn` / `float8_e5m2` | `float32` | 逐 token | A5/C310 |
| MXFP4 | `"fp4_e2m1"` | `float4_e2m1fn_x2` | `float8_e8m0fnu` | 每 32 元素 | A5/C310 |
...
- Normal dispatch 支持标量 FP8 逐 token 量化（`quant_mode="scalar_fp8"`）和 MXFP8 逐 block 量化。
