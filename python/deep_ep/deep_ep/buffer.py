...
class Buffer:
    ...
    def fused_deep_moe(self, x: torch.Tensor, expertIds: torch.Tensor, gmm1PermutedWeight: torch.Tensor, gmm1PermutedWeightScale: torch.Tensor,
                        gmm2Weight: torch.Tensor, gmm2WeightScale: torch.Tensor, expertSmoothScalesOptional: torch.Tensor,
    ...
    output, event, hook = self.runtime.fused_deep_moe(x, expertIds, gmm1PermutedWeight, gmm1PermutedWeightScale, gmm2Weight, 
                                                      ...
                                                      shareExpertRankNum, quantMode, globalBs)
    tensors_to_record = (x, expertIds, gmm1PermutedWeight, gmm1PermutedWeightScale, gmm2Weight, gmm2WeightScale,
