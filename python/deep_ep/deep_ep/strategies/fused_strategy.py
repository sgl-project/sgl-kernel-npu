...
class MegaMoeFusedStrategy(FusedEPStrategy):
    ...
    # deep_ep activation names -> cann_ops_transformer (CANN 9.2.0) op names
    _OP_ACTIVATION_NAMES = {
        "situ": "situglu",
        "swiglu_gpt_oss": "swigluoai",
    }

    @staticmethod
    def _build_activation_params(
        activation: str,
        beta: float,
        linear_beta: Optional[float],
        ...
        if linear_beta is not None:
            params["linear_beta"] = linear_beta
    ...
    def _execute_mega_moe(
        ...
        *,
        ...
        return mega_moe(
            ...
            activation=self._OP_ACTIVATION_NAMES.get(activation, activation),
            activation_clamp=activation_clamp,
            activation_params=self._build_activation_params(
