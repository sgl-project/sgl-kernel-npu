...
Includes: Cpp strategy, Ops strategy (MoeDistributeBuffer), and All2All strategy.
"""
...
class OpsLowLatencyCommStrategy(LowLatencyEPCommStrategy):
    """
    Low latency mode strategy using torch_npu ops (MoeDistributeBuffer). 
    This strategy uses the ops-transformer op for potentially better performance.
    """
    
    def __init__(self, runtime, group_name: str, group_size: int, rank: int, comm_alg: str = ""):
        super().__init__(group_name, group_size, rank)
