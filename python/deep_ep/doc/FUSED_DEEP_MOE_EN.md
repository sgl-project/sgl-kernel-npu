...
|-----------|------|-------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **x** | `torch.Tensor` | `[bs, hidden]` | Input token representations, where each row is the hidden vector of a token (commonly `bfloat16`). **bs** (batch size): Range **[1, 256]**. **hidden** : Represents the hidden dimension size, typically determined by the model's hidden layer width (e.g., 2048, 4096, 6144, 7168).<br> Range **[512, 7168]**, and must be divisible by **32** to meet the alignment requirements of underlying matrix multiplication and communication. |
