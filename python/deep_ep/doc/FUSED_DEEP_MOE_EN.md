...
| **quant_mode** | `int` | Scalar, default `1` | Indicates quantization mode:<br>`1`: int8;<br>This parameter is invalid on Ascend 950 hardware; the quantization method is determined internally based on the dtype of gmm1_permuted_weight, and currently only mxfp8 quantization is supported.                                                                                                                                                                                                                                                                                                                                                         |
