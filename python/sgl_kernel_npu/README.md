...
`910B` (A2), `910`/`910C` (A3) and `950` (Ascend 950) select the SoC family. Concrete Ascend 950
...
because several modules, including LoRA, have not yet been ported to the Ascend 950
pipeline model.
