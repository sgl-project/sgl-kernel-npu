...
"""
0.离散访存：将入参N声明为编译时常量
1.离散访存：a_ptr按行加载,insert_slice提升性能
2.离散访存：b_ptr转置后，insert_slice
...
if __name__ == "__main__":
    ...
    kernel_args = data#["input_data"]

    kernel_args["BLOCK_SIZE_N"] = 16
    kernel_args["BLOCK_SIZE_M"] = 16
    kernel_args["BLOCK_SIZE_K"] = 128
    kernel_args["mutibuffer"] = True
